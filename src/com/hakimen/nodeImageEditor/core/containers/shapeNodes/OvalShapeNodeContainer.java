...
public class OvalShapeNodeContainer extends NodeContainer {
    ...
    public OvalShapeNodeContainer(float x, float y) {
        super(x, y, "Oval Shape Node");
        ...
        writerNodes.put(OUTPUT, new ShapeNode(this, false, new Rectangle2D.Float(0, 0, 0, 0)));
    }
    ...
    public void update() {
        ...
        if (readerNodes.get(X) instanceof NumberNode x &&
            ...
            out.setValue(new Ellipse2D.Float(x.getValue().intValue(), y.getValue().intValue(), width.getValue().intValue(), height.getValue().intValue()));
        }
    }
}
